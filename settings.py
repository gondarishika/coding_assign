...
SECRET_KEY = "django-insecure-xkc+9g%1zq4cby)ve@b8^q$b_nvz*=i5(#na$-d5gxfdo0e=6="
...
# URL to redirect to password reset form
LOGIN_URL = '/accounts/login/'

# URL to redirect to password reset form
PASSWORD_RESET_URL = '/accounts/password_reset/'

# URL to redirect to password reset done page
PASSWORD_RESET_DONE_URL = '/accounts/password_reset/done/'

# URL to redirect to password reset complete page
